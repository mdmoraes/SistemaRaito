...
resourcestring
  ...
  SInvalidFrameIndex = 'Invalid image frame index %d: there are %d frames (0-%d)';
  ...
  SInRemoteSession = 'Cannot change SingleBufferingInRemoteSessions in a remote session';
...
{$ENDIF}
  ...
  SMsgDlgAbort = '&Abandonar';
  SMsgDlgRetry = '&Tentar de novo';
  ...
  SInvalidScaleImagePixelFormat = 'Bitmap PixelFormat must be pf24bit or p32bit';
  ...
  { Vcl.WinXPanels }
  SInvalidCardPanelActiveCardIndex = 'CardPanel card index is out of range';
  SInvalidCardPanelActiveCard = 'CardPanel.ActiveCard cannot be nil';

  {Vcl.ControlList}
  SGraphicControlAcceptedOnly = 'Only TGraphicControl class descendants are supported by ControlList';
